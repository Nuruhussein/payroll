                    ...
                    <table className="w-full table-auto text-sm text-left">
                        <thead className="bg-gray-50 text-gray-600 font-medium border-b">
                            <tr>
                                ...
                                <th className="py-3 px-6">employee_name</th>
                                <th className="py-3 px-6">basic_salary</th>
                        ...
                        <tbody className="text-gray-600 divide-y">
                            {payrolls.map((item, idx) => (
                                <tr key={idx}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">{item.employee.name}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{item.employee.basic_salary}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{item.employee.position}</td>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">{item.employer_pension}</td>
